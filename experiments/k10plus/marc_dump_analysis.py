...
"""
#TODO:
- test other tags with small data dump
- check how many contain 100_4 and 100_e in the same record and repeat the same for tag 700
- test with big data dump
"""
import io
                ...
                if matching_fields:
                    ...
                    if tag == "700" or tag == "100":
                        for j, field in enumerate(matching_fields):
                            ...
                            # but tag 100 is always a single person
